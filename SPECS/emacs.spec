...
Patch102:       emacs-htmlfontify-command-injection-vulnerability.patch
# CVE-2025-1244: shell injection via custom man URI scheme
Patch103:       emacs-man-uri-shell-injection-CVE-2025-1244.patch
...
%patch102 -p1 -b .htmlfontify-command-injection-vulnerability
%patch103 -p1 -b .man-uri-shell-injection
...
%changelog
* Thu Feb 12 2026 Andrew Jorgens <ajorgens@ciq.com> - 1:24.3-23.2
- Fix man.el shell injection vulnerability (CVE-2025-1244)

* Fri Apr 7 2023 Jacek Migacz <jmigacz@redhat.com> - 1:24.3-23.1
